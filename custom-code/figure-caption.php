<?php 
	if (!function_exists( 'mongabay_figure_caption' )) :
	
		function mongabay_figure_caption( $output, $attr, $content ) {
	...
	add_filter( 'img_caption_shortcode', 'mongabay_figure_caption', 10, 3 );
?>