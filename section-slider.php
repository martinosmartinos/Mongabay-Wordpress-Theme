<?php
    ...
    if ($query->have_posts()) {
            ...
            ?>
            <?php if ($i == 1): ?>
            	<div class="<?php echo $slideclass; ?>" style="background: url(<?php the_post_thumbnail_url('medium'); ?>);background-size: cover;">
            ...
            <?php endif; ?>
            <?php if ($i == 3): ?>
                    <div class="<?php echo $slideclass; ?>" style="background: url(<?php the_post_thumbnail_url('medium'); ?>);background-size: cover;border-left: 5px solid white;position: absolute;left: 0;top: 50%;">
                        <a href="<?php the_permalink(); ?>">
                            <div class="slider-headline responsive-title"><?php the_title(); ?></div>
                        </a>
                    </div>
